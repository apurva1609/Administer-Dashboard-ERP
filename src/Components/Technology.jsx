...
//   const handleClose = () => {
//     if ( technology_name || status !== "active") {
...
//   const [technology_name, setName] = useState("");
...
//     setLoading(true);
//     axios
//       .get("http://localhost:8000/getdataTechnology")
//       .then((res) => {
...
//     axios
//       .post("http://localhost:8000/addTechnology", newData)
//       .then((res) => {
...
//         "Sr.No": index + 1,
//         "Technology Name": a.technology_name,
//         "Status": a.status,
//       }))
//     );
...
//       body: userData.map((a, index) => [index + 1, a.technology_name, a.status]),
//       startY: 30,
//     });
...
//       item.technology_name.toLowerCase().includes(searchTerm.toLowerCase())||
