...
const College = () => {
  ...
  const handleClose = () => {
    if (university_name || college_name || city_name || status !== "active") {
  ...
  const handlePdf = () => {
    ...
    doc.autoTable({
      head: [["Sr.No", "College ID", "College Name", "Status"]],
      body: userData.map((a, index) => [index + 1, a.university_name, a.college_name, a.city_name, a.status]),
      startY: 30,
    });
